...
# revised by Maxime Lopez, 2025-02-05
#############################################################
#
...
PerSIMPER <- function(matrixSIMP,
  ...
  if (plotSIMPER == TRUE) {
    lines(UpG, lty="dotted", lwd=2, col="cornflowerblue")
    lines(LoG, lty="dotted", lwd=2, col="cornflowerblue")
    lines(UpO, lty="dotted", lwd=2, col="orange2")
    lines(LoO, lty="dotted", lwd=2, col="orange2")
